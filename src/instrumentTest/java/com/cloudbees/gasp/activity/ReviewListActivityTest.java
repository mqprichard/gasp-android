...
public class ReviewListActivityTest extends ActivityInstrumentationTestCase2<ReviewListActivity> {
    static final String TAG = ReviewListActivityTest.class.getName();

    private ReviewListActivity mActivity;

    public ReviewListActivityTest() {
        super(ReviewListActivity.class);
    }
