...
public class LocationSearchTest extends AndroidTestCase {
    private static final String TAG = LocationSearchTest.class.getName();
    ...
    public void placesSearch(Query query) {
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                try {
                    String search = GooglePlacesClient.getQueryStringLocationSearch(searchQuery);
                    Log.d(TAG, search);
            ...
            protected void onPostExecute(String jsonOutput) {
                ...
                // Google Places API will not return pagetoken queries immediately
            }
        }.execute();
    }
